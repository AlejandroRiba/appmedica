...
class GotasEdit : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lugarAplicacion = intent.getStringExtra("lugarApl") ?: "* Seleccione una opción"
    ...
    private fun inicializaSpinners(){
        ...
        //valor por default capturado del extra
        val itemsDosis = resources.getStringArray(R.array.dosis_gotas)
        ...
        //valor por default capturado del extra
        val itemsLugar = resources.getStringArray(R.array.lugar_admin_gotas)
        val indexLugar = itemsLugar.indexOf(lugarAplicacion)
        Log.i("MedEdit", "Medida: $lugarAplicacion")
        if (indexLugar != -1) {
            spinnerlugar.setSelection(indexLugar) // Seleccionar el índice encontrado
        }
