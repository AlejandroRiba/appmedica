...
class BebibleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Obtener referencia al Spinner medida de administración
        val spinner5: Spinner = findViewById(R.id.medida)
        ...
        // Crear un ArrayAdapter usando el string-array y un layout predeterminado para el spinner 3 cantidad
        ArrayAdapter.createFromResource(
            this,
            R.array.dosis_beb,
            R.layout.spinner_sangres
        ...
        // Crear un ArrayAdapter usando el string-array y un layout predeterminado para el spinner 5 medida de administración
        ArrayAdapter.createFromResource(
            this,
            R.array.medida_beb,
            R.layout.spinner_sangres
